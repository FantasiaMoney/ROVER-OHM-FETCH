...
contract CustomSplitFormula is Ownable {
  uint256 currentEthPercentTodex = 50;
  uint256 currentEthPercentToSale = 50;
  ...
  {
    ethPercentTodex = currentEthPercentTodex;
    ethPercentToSale = currentEthPercentToSale;
  }

  function setNewPercent(
    uint256 _currentEthPercentTodex,
    uint256 _currentEthPercentToSale
  )
    external
    onlyOwner
  {
